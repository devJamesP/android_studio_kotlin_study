package com.jamespark_h.fomodorotimeractivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startCountDown() {
        ...
        tickingSoundId?.let {soundId->
            soundPool.play(
                soundId, 1f, 1f, 1, -1, 1f
            )
        }
    }


// Create Timer and action
    private fun createCountDownTimer(initialMillis: Long) =
        object : CountDownTimer(initialMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                // finish sound and play bellSound
                completeCountDown()
    ...
    private fun completeCountDown() {
        soundPool.autoPause()
        bellSoundId?.let {
            soundPool.play(it, 1f, 1f, 1, 1, 1f)
        }
    }

    // Acting Timer :: UpdateUI
