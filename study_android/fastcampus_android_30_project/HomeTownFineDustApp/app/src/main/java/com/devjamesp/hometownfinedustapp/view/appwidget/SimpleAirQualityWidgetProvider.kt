package com.devjamesp.hometownfinedustapp.view.appwidget
...
class SimpleAirQualityWidgetProvider : AppWidgetProvider() {
    ...
    class UpdateWidgetService : LifecycleService() {
                    ...
                    lifecycleScope.launch {
                        try {
                            val nearbyMonitoringStation =
                                Repository.getNearbyMonitoringStation(location.longitude,
                                    location.latitude)
                            val measuredValue =
        ...
        private fun createNotification(): Notification =
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                Notification.Builder(this, WIDGET_REFRESH_CHANNEL_ID)
